...
| `release-unit`             | npm run test:release-unit (Nx: repository:test:release-unit)               | blocking      | node-24, node-26  | —                                                  | unit-coverage, unit-junit | vitest; exclude: tests/integration/**                                                                                                                                                                                     |
...
| `worker-http`              | npm run test:worker-http (Nx: repository:test:worker-http)                 | blocking      | workerd           | —                                                  | —                         | vitest; include: tests/integration/worker-http.integration.test.ts                                                                                                                                                        |
| `pack`                     | npm run test:pack (Nx: repository:test:pack)                               | blocking      | node-24           | —                                                  | node-package              | npm-pack-smoke                                                                                                                                                                                                            |
| `cli`                      | npm run test:cli (Nx: repository:test:cli)                                 | blocking      | node-24           | —                                                  | —                         | workspace-test; workspace: @chrisdoc/hevy-cli                                                                                                                                                                             |
| `pack-cli`                 | npm run test:pack:cli (Nx: repository:test:pack:cli)                       | blocking      | node-24           | —                                                  | cli-package               | npm-pack-smoke; workspace: @chrisdoc/hevy-cli                                                                                                                                                                             |
...
| `package-boundaries`       | npm run check:boundaries (Nx: repository:check:boundaries)                 | blocking      | node-24, node-26  | —                                                  | —                         | control-plane; check: boundaries                                                                                                                                                                                          |
...
| `types`                    | npm run check:types (Nx: repository:check:types)                           | blocking      | node-24, node-26  | —                                                  | —                         | typescript; project: tsconfig.json                                                                                                                                                                                        |
| `check`                    | npx nx run repository:check                                                | blocking      | node-24, node-26  | —                                                  | —                         | repository-check                                                                                                                                                                                                          |
| `build`                    | npm run build (Nx: repository:build)                                       | blocking      | node-24, node-26  | —                                                  | node-package              | package-build; workspace: hevy-mcp                                                                                                                                                                                        |
...
| `diagnostics`              | npx nx run repository:test:diagnostics                                     | blocking      | node-24           | —                                                  | nightly-diagnostics       | node-test; include: tests/nightly/diagnostics.test.mjs                                                                                                                                                                    |
