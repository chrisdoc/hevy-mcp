...
| -------------------------- | -------------------------------------- | ------------------------------ | ------------------------- | ------------------------------------------------------------------------------------------------------ | -------------- | ------------: | -------------------------------------------------- | ----------------------------------------------------------------- |
| `unit`                     | pull-request, pull-request-ci          | node-24 (24.x), node-26 (26.x) | —                         | pull-request-ci node-24: HEVY_TEST_REPORT_MODE=ci<br>pull-request-ci node-26: HEVY_TEST_REPORT_MODE=ci | enumerated     |          1302 | —                                                  | unit-coverage, unit-junit                                         |
| `release-unit`             | release                                | node-24 (24.x), node-26 (26.x) | node-24                   | —                                                                                                      | enumerated     |          1305 | —                                                  | —                                                                 |
| `mocked-mcp`               | pull-request, pull-request-ci          | node-24 (24.x), node-26 (26.x) | —                         | pull-request-ci node-24: HEVY_TEST_REPORT_MODE=ci<br>pull-request-ci node-26: HEVY_TEST_REPORT_MODE=ci | enumerated     |           109 | —                                                  | mocked-coverage                                                   |
| `contract`                 | pull-request, pull-request-ci          | node-24 (24.x)                 | —                         | pull-request-ci node-24: HEVY_TEST_REPORT_MODE=ci                                                      | enumerated     |            44 | —                                                  | —                                                                 |
| `stdio`                    | pull-request, pull-request-ci          | node-24 (24.x)                 | —                         | —                                                                                                      | enumerated     |            55 | —                                                  | stdio-diagnostics                                                 |
| `worker`                   | pull-request, pull-request-ci, release | workerd (wrangler-local)       | node-24                   | pull-request-ci node-24: HEVY_TEST_REPORT_MODE=ci                                                      | enumerated     |             2 | —                                                  | —                                                                 |
| `worker-http`              | pull-request, pull-request-ci          | workerd (wrangler-local)       | node-24                   | pull-request-ci node-24: HEVY_TEST_REPORT_MODE=ci                                                      | enumerated     |            11 | —                                                  | worker-bundle                                                     |
| `pack`                     | pull-request, pull-request-ci, release | node-24 (24.x)                 | —                         | —                                                                                                      | not-applicable |             — | —                                                  | node-package-tarball                                              |
| `cli`                      | pull-request, pull-request-ci, release | node-24 (24.x)                 | —                         | pull-request-ci node-24: HEVY_TEST_REPORT_MODE=ci                                                      | enumerated     |            80 | —                                                  | cli-dist                                                          |
...
from its workspace. Unit sets `HEVY_UNIT_LANE=1`; explicit per-lane,
per-runtime `workflowEnvironment` metadata records workflow overrides such as
`HEVY_TEST_REPORT_MODE=ci`. Artifact IDs above come from the canonical lane
...
1,302 identities under `HEVY_UNIT_LANE=1`; 2 identities present only when the
...
the test-name comparison. For the complete report, run
