...
| `package-boundaries`       | npm run check:boundaries (Nx: repository:check:boundaries)                 | blocking      | node-24, node-26  | —                                                  | core-source, hevy-client-source, worker-bundle | control-plane; check: boundaries                                                                                                                                                                                          |
...
| `types`                    | npm run check:types (Nx: repository:check:types)                           | blocking      | node-24, node-26  | —                                                  | core-source, hevy-client-source                | typescript; project: tsconfig.json                                                                                                                                                                                        |
...
| `pull-request-ci` | external: github-actions               | `repository-control-plane`, `workspace-topology`, `package-boundaries`, `package-exports`, `release-candidates`, `types`, `server-manifest`, `check`, `package-changesets`, `diagnostics`, `build`, `worker-http`, `worker`, `mocked-mcp`, `unit`, `contract`, `stdio`, `cli`, `pack-cli`, `worker-bundle`, `performance` | 21    | external |
| `release`         | npx nx run repository:release:validate | `build`, `release-unit`, `worker`, `cli`, `pack-cli`, `release-integration`, `nightly`, `worker-http-live`                                                                                                                                                                                                                | 8     | mapped   |
