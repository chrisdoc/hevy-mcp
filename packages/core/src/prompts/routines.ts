				...
				messages: [
					{
						...
						content: {
							...
							text: [
								...
								"Choose candidate movements, then resolve every one to an existing Hevy exercise template. Use search-exercise-templates when a movement name is known and get-exercise-templates for open-ended browsing. Never guess an exercise_template_id.",
								...
								"Propose one routine with a title, optional existing folder, ordered exercises, set types, fixed target reps, rest_seconds, and useful notes. Default to normal sets and omit prescribed weights unless I provided them.",
