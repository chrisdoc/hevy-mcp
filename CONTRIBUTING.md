...
| --------------------- | -------------------------------- | ------------- | ----------------- | -------------------------------------------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `unit`                | npm run test:unit                | blocking      | node-24, node-26  | —                                                  | unit-coverage, unit-junit | vitest; exclude: tests/integration/**, tests/performance/**                                                                                                                                                               |
| `release-unit`        | npm run test:release-unit        | blocking      | node-24, node-26  | —                                                  | unit-coverage, unit-junit | vitest; exclude: tests/integration/**                                                                                                                                                                                     |
| `mocked-mcp`          | npm run test:mcp                 | blocking      | node-24, node-26  | —                                                  | mocked-coverage           | vitest; include: tests/integration/mocked/**                                                                                                                                                                              |
| `contract`            | npm run test:contract            | blocking      | node-24           | —                                                  | —                         | vitest; include: packages/node/src/index.test.ts, packages/node/src/utils/config.test.ts, packages/core/src/tools/register.test.ts, packages/core/src/utils/output-schemas.test.ts, tests/unit/server-manifest.test.ts    |
| `stdio`               | npm run test:stdio               | blocking      | node-24           | —                                                  | stdio-diagnostics         | vitest; include: packages/node/src/index.test.ts, packages/node/src/utils/stdio-observability.test.ts, packages/node/src/utils/graceful-shutdown.test.ts, packages/node/src/utils/graceful-shutdown.child-process.test.ts |
| `worker`              | npm run test:worker              | blocking      | workerd           | —                                                  | —                         | vitest-worker-config; config: vitest.workers.config.ts                                                                                                                                                                    |
| `worker-http`         | npm run test:worker-http         | blocking      | workerd           | —                                                  | —                         | vitest; include: tests/integration/worker-http.integration.test.ts                                                                                                                                                        |
| `pack`                | npm run test:pack                | blocking      | node-24           | —                                                  | node-package              | npm-pack-smoke                                                                                                                                                                                                            |
| `cli`                 | npm run test:cli                 | blocking      | node-24           | —                                                  | —                         | workspace-test; workspace: @chrisdoc/hevy-cli                                                                                                                                                                             |
| `pack-cli`            | npm run test:pack:cli            | blocking      | node-24           | —                                                  | cli-package               | npm-pack-smoke; workspace: @chrisdoc/hevy-cli                                                                                                                                                                             |
| `performance`         | npm run test:performance         | informational | node-24           | —                                                  | performance-summary       | vitest; include: tests/performance/performance.test.ts                                                                                                                                                                    |
| `workspace-topology`  | npm run check:workspaces         | blocking      | node-24, node-26  | —                                                  | —                         | control-plane; check: topology                                                                                                                                                                                            |
| `package-boundaries`  | npm run check:boundaries         | blocking      | node-24, node-26  | —                                                  | —                         | control-plane; check: boundaries                                                                                                                                                                                          |
| `package-exports`     | npm run check:exports            | blocking      | node-24, node-26  | —                                                  | —                         | control-plane; check: exports                                                                                                                                                                                             |
| `release-candidates`  | npm run check:release-candidates | blocking      | node-24, node-26  | —                                                  | —                         | control-plane; check: release-candidates                                                                                                                                                                                  |
| `package-changesets`  | npm run check:package-changesets | blocking      | node-24           | —                                                  | —                         | control-plane; check: changesets                                                                                                                                                                                          |
| `changeset-status`    | npm run check:changeset          | blocking      | node-24           | —                                                  | —                         | changeset-status                                                                                                                                                                                                          |
| `types`               | npm run check:types              | blocking      | node-24, node-26  | —                                                  | —                         | typescript                                                                                                                                                                                                                |
| `check`               | npm run check:repository         | blocking      | node-24, node-26  | —                                                  | —                         | repository-check                                                                                                                                                                                                          |
| `build`               | npm run build                    | blocking      | node-24, node-26  | —                                                  | node-package              | package-build; workspace: hevy-mcp                                                                                                                                                                                        |
| `worker-bundle`       | npm run worker:dry-run           | blocking      | workerd           | —                                                  | worker-bundle             | wrangler-dry-run                                                                                                                                                                                                          |
| `server-manifest`     | npm run check:server-manifest    | blocking      | node-24, node-26  | —                                                  | server-manifest           | manifest-drift                                                                                                                                                                                                            |
| `docker`              | external: docker workflow        | blocking      | node-24           | —                                                  | docker-image              | docker-smoke                                                                                                                                                                                                              |
| `generation`          | external: issue-870              | blocking      | node-24, node-26  | —                                                  | generated-client          | generated-output-closure                                                                                                                                                                                                  |
| `integration-live`    | npm run test:live                | release       | node-24           | HEVY_API_KEY                                       | live-diagnostics          | vitest-live                                                                                                                                                                                                               |
| `worker-http-live`    | npm run test:worker-http:live    | release       | workerd           | HEVY_API_KEY, HEVY_RUN_LIVE_WORKER_TESTS           | live-worker-diagnostics   | worker-live                                                                                                                                                                                                               |
| `release-integration` | npm run test:integration         | release       | node-24           | HEVY_API_KEY                                       | live-diagnostics          | vitest-integration; include: tests/integration/**                                                                                                                                                                         |
| `nightly`             | npm run test:nightly             | nightly       | node-24           | HEVY_API_KEY, HEVY_MCP_COMMAND, HEVY_MCP_ARGS_JSON | nightly-diagnostics       | launcher-canary                                                                                                                                                                                                           |

<!-- repository-control-plane:validation-lanes:end -->

The stable lane identities, runtime matrix, credentials, artifacts, and
change-impact routing are owned by
[`repository/validation-lanes.json`](repository/validation-lanes.json). The
command aliases in this table remain supported for one release cycle; use
[`docs/test-lanes.md`](docs/test-lanes.md) for the generated lane registry.
