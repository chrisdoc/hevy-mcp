...
| `packages/core/src/protocol/output-schemas.ts`         | `formattedWorkoutSetSchema`, `formattedWorkoutExerciseSchema`, `formattedRoutineSetSchema`, `formattedRoutineExerciseSchema`                                                                               |
| `packages/core/src/protocol/response-contracts.ts`     | `workoutCountResponse`                                                                                                                                                                                     |
...
| `packages/core/src/protocol/output-schemas.ts`         | `FormattedExerciseTemplate`                                                                                                         |
| `packages/core/src/utils/pagination.ts`                | `PageResult`                                                                                                                        |
| `packages/core/src/protocol/response-contracts.ts`     | `WorkflowTelemetry`                                                                                                                 |
